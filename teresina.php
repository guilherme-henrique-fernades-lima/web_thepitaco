            ...
            <?php foreach ($blogs1 as $blog1) { ?>
                <div class="pt-2">
                    <div class="border border-transparent hover:border-color2 border-2 rounded-md">
                        <a class="grid grid-cols px-1 flex justify-center" href="<?php echo $URI->base('blog/' . slugify($blog1['name'])); ?>">
                            <img class='lazy rounded-lg h-48 object-cover w-full' src='./admin/uploads/blogs/<?php echo $blog1['img'] ?>' alt="<?php echo $blog['name']; ?>">
                            <div class="ml-4 mt-2">
