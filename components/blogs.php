  ...
  <div class="mx-auto max-w-7xl px-2 pt-4">
    ...
    <div class="flex flex-col">
      <?php foreach ($blogs as $blog) { ?>
        <div class="mt-4 px-2">
          <a class="grid md:flex items-center h-auto lg:h-56 max-w-4xl border border-transparent hover:border-color2 border-2 rounded-md px-2" href="<?php echo $URI->base('blog/' . slugify($blog['name'])); ?>">
            <img class='lazy rounded-lg h-48 cover w-full md:w-2/5' src='./admin/uploads/blogs/<?php echo $blog['img'] ?>'>
            <div class="ml-4">
