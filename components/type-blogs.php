                ...
                <?php foreach ($blogs as $blog) { ?>
                    <div class="mt-4 px-2">
                        <div class="border border-transparent hover:border-color2 border-2 rounded-md">
                            <a class="grid grid-cols px-2" href="<?php echo $URI->base('blog/' . slugify($blog['name'])); ?>">
                                <img class='lazy rounded-lg h-48 cover' src='./admin/uploads/blogs/<?php echo $blog['img'] ?>'>
                                <div class="ml-4">
            ...
            <div class="flex">
                <div class="flex justify-center">
                    <?php foreach ($blogs1 as $blog1) { ?>
                        <div class="mt-4 px-2">
                            <div class="border border-transparent hover:border-color2 border-2 rounded-md">
                                <a class="grid grid-cols px-2" href="<?php echo $URI->base('blog/' . slugify($blog1['name'])); ?>">
            ...
            <div class="flex">
                <div class="flex justify-center">
                    <?php foreach ($blogs2 as $blog2) { ?>
                        <div class="mt-4 px-2">
                            <div class="border border-transparent hover:border-color2 border-2 rounded-md">
                                <a class="grid grid-cols px-2" href="<?php echo $URI->base('blog/' . slugify($blog2['name'])); ?>">
            ...
            <div class="flex">
                <div class="flex justify-center">
                    <?php foreach ($blogs3 as $blog3) { ?>
                        <div class="mt-4 px-2">
                            <div class="border border-transparent hover:border-color2 border-2 rounded-md">
                                <a class="grid grid-cols px-2" href="<?php echo $URI->base('blog/' . slugify($blog3['name'])); ?>">
